...
export class ManageUserComponent implements OnInit {
  ...
  exelExport() {
    this.exporter.exportTable(ExportType.XLSX, {
      fileName: "KPR_Users_Details_" + this.currentDateTime,
    });
  }
  ...
  pdfExport() {
    ...
    doc.text("KPR Users Details", 15, 25);
    ...
    autoTable(doc, {
      ...
      columns: [
        ...
        { header: "User Role ", dataKey: "userRoleId" },
      ],
      didParseCell: function (data) {
        if (data.column.dataKey === "userRoleId") {
          var text = data.row.raw["name"];
    ...
    doc.save("KPR_Users_Details_" + this.currentDateTime);
  }
